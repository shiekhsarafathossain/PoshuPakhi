...
if (isset($_GET['edit_orders'])) {
    ...
    $user_shipping_address = $row['user_shipping_address'];
...
if (isset($_POST['update_order'])) {
    ...
    $update_query = "UPDATE user_orders SET invoice_number='$invoice_number', total_products='$total_products', amount_due='$amount_due', estimated_delivery='$estimated_delivery', user_shipping_address='$user_shipping_address', order_status='$status' WHERE order_id='$order_id'";
...
<body>
    ...
    <form method="post">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="number" name="total_products" id="total_products" class="form-control" required value="<?php echo $total_products; ?>">
        </div>
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="user_shipping_address" class="form-label">Shipping Address:</label>
            <input type="text" name="user_shipping_address" id="user_shipping_address" class="form-control" required value="<?php echo $user_shipping_address; ?>">
        </div>
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="user_shipping_address" class="form-label">Status:</label>
            <select name="status">
